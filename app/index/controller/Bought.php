...
class Bought extends CommonController
{
  ...
  public function index(): Json
  {
    ...
    $data = $query->page($this->page, $this->pageSize)
      ...
      ->column("e.id,e.company,e.avatar,e.name,e.members,e.expire_date,e.joinable_wc,b2.add_time buy_time,b2.price,b2.down_cnt,e.qr,e.im,e.type,IFNULL(b1.buy_cnt_month,0) buy_cnt");
